...
export default function Recharge({ navigation }) {
  ...
  var data = [
    { id: "1", nameBack: "TpBank", vat: "0.01$" ,imgBank: "https://bankcredit.vn/wp-content/uploads/2022/09/hinh-3333-10.jpg"},
    { id: "2", nameBack: "BIDV", vat: "Free" ,imgBank: "https://image.bnews.vn/MediaUpload/Org/2022/04/26/logo-bidv-20220426071253.jpg"},
  ...
  const recharge = async () =>{
    ...
    try {
      ...
      if (response.data.status === 0) {
        ...
        console.log(auth);
        isRecharge? 
    navigation.navigate("DepositSuccessful") : navigation.navigate("DepositFailed")
      }
        ...
        <View style={styles.contentContainer}>
          <View style={styles.RMoney}>
            ...
            <View style={styles.topUpMoneyInput}>
              ...
              <TextInput
                ...
                placeholder="0 $" 
                onChangeText={(money)=>setMonney(money)}
              ></TextInput>
            </View>
          </View>
          <View style={styles.SourceOfFundHeader}>
            ...
            <View style={styles.SourceOfFund}>
              {data.map  ((item,index)=>(
                    <View style={styles.Itemcontainer} key={item.id}>
                      <View style={styles.wp_item}>
                        <View><Image source={{uri: item.imgBank}} style={styles.ImageBank} resizeMode="cover"/></View>
                        <View>
              ...
              <View >
              <TouchableOpacity style={styles.Itemcontainer} onPress={()=>navigation.navigate('AddBank')}>
                      <View style={styles.wp_item}>
                        <View><Image source={require("../../../public/bank.jpg") } style={styles.ImageBank} resizeMode="cover"/></View>
                        <View>
                          <Text>Add Bank</Text>
